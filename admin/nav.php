...
<div class="sidebar">
  ...
  <nav class="sidebar-nav" id="sidebar-nav">
    ...
    <a href="artikel.php" class="sidebar-link <?= in_array($active_nav, ['artikel', 'artikel-editor'], true) ? 'active' : '' ?>" <?= in_array($active_nav, ['artikel', 'artikel-editor'], true) ? 'aria-current="page"' : '' ?>>
